...
def cluster_words_intermediate(
    ...
    return plot_silhouette_and_sse(11, data), data, df_t


def display_clusters(n_clusters, data, df_t):
    return (plot_clusters_on_pc_spectral_3d(n_clusters, data, marker_size=1.4), visualize_main_words_in_clusters_TFIDF(n_clusters, data, df_t))
